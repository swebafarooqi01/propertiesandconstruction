...
const UpdateConstruction = () => {
  ...
  const handleSubmit = (formData) => {
    updateConstruction(selectedConstruction.id, formData);
    navigate('/dashboard');
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8">
          <button
            onClick={() =>
              selectedConstruction ? setSelectedConstruction(null) : navigate('/dashboard')
            }
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Update Construction Project</h1>
              <p className="text-gray-500 mt-1">
                {selectedConstruction
                  ? `Editing: ${selectedConstruction.name}`
        ...
        {!selectedConstruction ? (
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            {constructions.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-gray-500">Create a construction project first to update it.</p>
              </div>
            ) : (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            <ItemForm
              initialData={selectedConstruction}
