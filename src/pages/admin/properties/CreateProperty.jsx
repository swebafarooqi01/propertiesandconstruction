...
const CreateProperty = () => {
  ...
  const handleSubmit = (formData) => {
    addProperty({ ...formData, rate: formData.price });
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-1">Add a new property listing</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
          <ItemForm onSubmit={handleSubmit} submitLabel="Create Property" itemType="Property" />
        </div>
      </main>
    </div>
  );
