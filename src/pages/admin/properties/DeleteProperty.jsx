...
const DeleteProperty = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          {properties.length === 0 ? (
            ...
            <div className="space-y-4">
              {properties.map((property) => (
                <div key={property.id} className="flex items-center justify-between p-5 border-2 border-gray-100 rounded-xl hover:border-red-200 hover:bg-red-50/50 transition-all duration-300">
                  <div className="flex items-center space-x-4">
                  ...
                  <button onClick={() => openDeleteModal(property)} className="p-3 text-red-600 hover:bg-red-100 rounded-xl transition-colors">
      ...
      <DeleteConfirmModal isOpen={showModal} onClose={() => setShowModal(false)} onConfirm={handleDelete} itemName={selectedProperty?.name} />
    </div>
  );
};
