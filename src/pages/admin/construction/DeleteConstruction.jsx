...
const DeleteConstruction = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Delete Construction</h1>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
          {constructions.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-500">There are no projects to delete.</p>
            </div>
          ) : (
            <div className="space-y-4">
              {constructions.map((construction) => (
                <div key={construction.id} className="flex items-center justify-between p-5 border-2 border-gray-100 rounded-xl hover:border-red-200 hover:bg-red-50/50 transition-all duration-300">
                  <div className="flex items-center space-x-4">
                  ...
                  <button onClick={() => openDeleteModal(construction)} className="p-3 text-red-600 hover:bg-red-100 rounded-xl transition-colors">
      ...
      <DeleteConfirmModal isOpen={showModal} onClose={() => setShowModal(false)} onConfirm={handleDelete} itemName={selectedConstruction?.name} />
    </div>
  );
};
